...
setIsCatMenuOpen(false); }}
          ...
          {/* THE NEW DESKTOP ACCOUNT BUTTON */}
          <Link href="/account" className="flex flex-col leading-tight p-1 border border-transparent hover:border-white cursor-pointer rounded text-white text-left ml-4">
            {isMounted && isLoggedIn ? (
              ...
              <>
                ...
                <span className="text-sm font-bold">Sign Up / Account</span>
              </>
            )}
          </Link>

          {/* THE NEW DESKTOP ORDERS BUTTON */}
          <Link href="/orders" className="flex flex-col leading-tight p-1 border border-transparent hover:border-white cursor-pointer rounded text-white text-left ml-2">
      ...
      <nav className="md:hidden flex flex-col w-full bg-gradient-to-r from-ethoDark to-haitiBlue text-white border-b-[3px] border-haitiRed relative z-50 shadow-md">
        ...
        <div className="px-3 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* THE NEW MOBILE ACCOUNT BUTTON */}
            <Link href="/account" className="flex flex-col text-white text-left leading-tight">
              {isMounted && isLoggedIn ? (
                <>
                  <span className="text-[10px] font-normal">Hello, {userLastName}</span>
            ...
            {/* THE NEW MOBILE ORDERS BUTTON */}
            <Link href="/orders" className="flex flex-col text-white text-left leading-tight">
                <span className="text-[10px] font-normal">Returns</span>
                <span className="text-xs font-bold">& Orders</span>
            </Link>

            <Link href="/cart" className="relative text-white ml-1">
