...
export const metadata = {
  ...
  description: 'Privacy Policy for EthoHaiti outlining how we collect, use, and protect your data.',
};
    ...
    <main className="pt-32 pb-20 min-h-screen bg-ethoBg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-ethoDark mb-4">Privacy Policy</h1>
        ...
        <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-gray-200">
          <div className="max-w-none text-gray-600">
            ...
            <p className="mb-5 leading-relaxed">
              This Privacy Policy describes how EthoHaiti (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from <Link href="https://ethohaiti.com" className="text-haitiBlue hover:underline font-bold">https://ethohaiti.com</Link> (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
            </p>
            <p className="mb-10 leading-relaxed">
              Please read this Privacy Policy carefully. By using and accessing any of the Services, you agree to the collection, use, and disclosure of your information as described in this Privacy Policy. If you do not agree to this Privacy Policy, please do not use or access any of the Services.
            </p>

            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">Changes to This Privacy Policy</h2>
            <p className="mb-10 leading-relaxed">
              We may update this Privacy Policy from time to time, including to reflect changes to our practices or for other operational, legal, or regulatory reasons. We will post the revised Privacy Policy on the Site, update the "Last updated" date and take any other steps required by applicable law.
            </p>

            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">How We Collect and Use Your Personal Information</h2>
            <p className="mb-5 leading-relaxed">
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">What Personal Information We Collect</h2>
            <p className="mb-10 leading-relaxed">
              The types of personal information we obtain about you depends on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you. The following sections describe the categories and specific types of personal information we collect.
            </p>

            <h3 className="text-xl font-extrabold text-ethoDark mt-8 mb-4">Information We Collect Directly from You</h3>
            <p className="mb-3 leading-relaxed">Information that you directly submit to us through our Services may include:</p>
            ...
            <h3 className="text-xl font-extrabold text-ethoDark mt-8 mb-4">Information We Collect through Cookies</h3>
            <p className="mb-10 leading-relaxed">
            ...
            <h3 className="text-xl font-extrabold text-ethoDark mt-8 mb-4">Information We Obtain from Third Parties</h3>
            <p className="mb-3 leading-relaxed">
              Finally, we may obtain information about you from third parties, including from vendors and service providers who may collect information on our behalf, such as:
            </p>
            <ul className="list-disc pl-6 mb-5 space-y-2 leading-relaxed">
              <li><strong>Infrastructure and Fulfillment Partners:</strong> Companies who support our Site, database architecture, and order fulfillment processes, such as Printify.</li>
              <li><strong>Payment Processors:</strong> Services that collect payment information (e.g., bank account, credit or debit card information, billing address) to process your payment via platforms like PayPal or Stripe in order to fulfill your orders and provide you with products or services you have requested, in order to perform our contract with you.</li>
              <li><strong>Tracking Technologies:</strong> When you visit our Site, open or click on emails we send you, or interact with our Services or advertisements, we, or third parties we work with, may automatically collect certain information using online tracking technologies such as pixels, web beacons, software developer kits, third-party libraries, and cookies.</li>
            </ul>
            <p className="mb-10 leading-relaxed">
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">How We Use Your Personal Information</h2>
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">Cookies</h2>
            <p className="mb-5 leading-relaxed">
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">How We Disclose Personal Information</h2>
            <p className="mb-3 leading-relaxed">
              In certain circumstances, we may disclose your personal information to third parties for legitimate purposes subject to this Privacy Policy. Such circumstances may include:
            </p>
            <ul className="list-disc pl-6 mb-5 space-y-2 leading-relaxed">
              <li>With vendors or other third parties who perform services on our behalf (e.g., IT management, payment processing, data analytics, customer support, cloud storage, print-on-demand fulfillment, and shipping).</li>
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">User Generated Content</h2>
            <p className="mb-5 leading-relaxed">
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">Third Party Websites and Links</h2>
            <p className="mb-10 leading-relaxed">
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">Children's Data</h2>
            <p className="mb-5 leading-relaxed">
            ...
            <h2 className="text-2xl font-extrabold text-ethoDark mt-12 mb-6">Security and Retention of Your Information</h2>
            <p className="mb-10 leading-relaxed">
            ...
            <p className="mb-10 leading-relaxed">
              For more information about our privacy practices, or if you have questions or would like to make a complaint, please contact us by e-mail at <a href="mailto:sakpase@ethohaiti.com" className="text-haitiBlue hover:underline font-bold">sakpase@ethohaiti.com</a>.
            </p>
