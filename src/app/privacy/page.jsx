    ...
    <main className="pt-32 pb-20 min-h-screen bg-ethoBg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-gray-200">
          <div className="prose prose-gray max-w-none prose-headings:font-extrabold prose-headings:text-ethoDark prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600 prose-a:text-haitiBlue prose-a:no-underline hover:prose-a:underline">
            
            <p>
              This Privacy Policy describes how EthoHaiti (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from <Link href="https://ethohaiti.com">https://ethohaiti.com</Link> (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
            </p>
            <p>
            ...
            <h2>Contact Us</h2>
            <p>
              For more information about our privacy practices, or if you have questions or would like to make a complaint, please contact us by e-mail at <a href="mailto:sakpase@ethohaiti.com">sakpase@ethohaiti.com</a>.
            </p>
