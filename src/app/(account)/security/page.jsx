...
export default function SecurityPage() {
  ...
  const handleSaveProfile = async (e) => {
    ...
    // Only send the password update if they actually typed something new
    ...
    try {
      ...
      if (data.id) {
        ...
        setNewPassword(''); // Clear the password field for safety
      } else {
          ...
          <form onSubmit={handleSaveProfile} className="p-6 space-y-6">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-haitiBlue focus:outline-none mb-2 text-black" 
              />
            </div>
